...
export default function ChampionCard({ trainerName, playerStats, regionProgress, onClose }) {
  ...
  return (
    <div className="cc-overlay" onClick={onClose}>
      <div className="cc-wrapper" onClick={e => e.stopPropagation()}>

        <button className="cc-close" onClick={onClose}>✕ CLOSE</button>
        ...
        >
          ...
          <div className="cc-top">
            <div className="cc-champion-badge">⭐ CHAMPION</div>
            <div className="cc-hp">
